...
class Learner(BaseLearner):
    ...
    def incremental_train(self, data_manager):
        ...
        from utils.make_imbalance import make_inter_class_imbalance, make_intra_task_imbalance, count_classes
        from collections import Counter

        imbalance = "inter"
        mode = 'descending' # 'descending', 'random', 'automatic' 
